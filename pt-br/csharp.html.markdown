...
C# é uma linguagem orientada a objeto elegante e typesave, que permite aos
desenvolvedores construir uma variedade segura e robusta de aplicações que
rodam em cima do framework .NET

[Leia mais aqui.](http://msdn.microsoft.com/en-us/library/vstudio/z1zx9t92.aspx)

```c#
// Comentários de uma única linha começam com //
/*
Comentários multi-linha tem essa cara
*/
/// <summary>
/// Isto é um comentário usado na geração de documentação, usando XML
/// </summary>

// Especifique quais namespaces a aplicação irá utilizar
using System;
...
// define o escopo e ajuda a organizar o código em "pacotes"
namespace Learning
{
    // Each .cs file should at least contain a class with the same name as the file
	// Cara arquivo .cs deve conter pelo menos uma classe com o mesmo nome do
    // arquivo. 
	// TODO: Verificar!!!
    // you're allowed to do otherwise, but shouldn't for sanity.
    public class LearnCSharp
    {
        // SINTAXE BÁSICA - pule para CARACTERÍSTICAS INTERESSANTES se você já
utilizou Java ou C++ 
        public static void Syntax() 
        {
            // Use Console.WriteLine para escrever linhas 
			...
			// Para escrever sem a quebra de linha, use Console.Write
            Console.Write("Hello ");
            Console.Write("World");
            ...
            // Sbyte - Um inteiro Signed de 8-bit
            // (-128 <= sbyte <= 127)
            sbyte fooSbyte = 100;

            // Byte - Um inteiro Unsigned 8-bit
            // (0 <= byte <= 255)
            byte fooByte = 100;
            ...
            // Integer - Inteiro de 32-bit
            int fooInt = 1; // (-2,147,483,648 <= int <= 2,147,483,647)
            uint fooUint = 1; // (0 <= uint <= 4,294,967,295)

            // Long - Inteiro de 64-bit 
            long fooLong = 100000L; // (-9,223,372,036,854,775,808 <= long <= 9,223,372,036,854,775,807)
            ulong fooUlong = 100000L; // (0 <= ulong <= 18,446,744,073,709,551,615)
			// Por padrão, os números sempre serão do tipo uint ou int,
			// dependendo do tamanho. A letra L é usada para representar uma
			// variável do tipo long ou ulong.
			
			// Double - Ponto flutuante IEEE 754 de 64 bit com precisão dupla
            double fooDouble = 123.4; // Precisão: 15-16 dígitos

			// Float - Ponto flutuante IEEE 754 com precisão
            float fooFloat = 234.5f; // Precision: 7 digits
			// a letra f é usada para representar o valor da variável do tipo float

			// Decimal - Um tipo de dado com 128 bits, com mais precisão do que
outros tipos de pontos flutuantes.
			// É muito usado em cálculos financeiros e monetários.
            decimal fooDecimal = 150.3m;

            // Boolean - true & false
            bool fooBoolean = true; // ou false

			// Char - Um caracter Unicode 16 bit
            char fooChar = 'A';

			// Strings - Ao contrários dos tipos anteriores, todos tipos de
			// valor, uma string é considerada um tipo de referência. 
			// Isto é, você poderá atribuí-la o valor null.
            string fooString = "\"escape\" quotes and add \n (new lines) and \t (tabs)";
            Console.WriteLine(fooString);

			// Você pode acessar acara caracter da string com seu respectivo índice:
